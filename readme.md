# ☕ Coffee Shop Sales Analysis (Jan 2023 – Jun 2023)

## 📌 Project Overview
This project is my **first Data Analytics project**, where I analyzed **Coffee Shop Sales data from January 2023 to June 2023** using **MySQL** and created an interactive dashboard in **Power BI**.

The objective of this project was to clean, analyze, and visualize sales data to extract meaningful business insights such as sales trends, peak hours, product performance, and store-wise sales.

---

## 📂 Dataset Information
- **Dataset Name:** Coffee Shop Sales  
- **Time Period Covered:** January 2023 – June 2023  
